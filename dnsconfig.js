...
// cxsrv.de
D("cxsrv.de", REG_CHANGEME, MAIL01,
...
// rsmg-clan.de
D("rsmg-clan.de", REG_CHANGEME, MAIL01,

  // CNAME
  CNAME("amongus", "dh1.cxsrv.de."), CNAME("cloud", "data.cxsrv.de."),
  CNAME("crewlink", "voice.cxsrv.de."), CNAME("git", "data.cxsrv.de."),
