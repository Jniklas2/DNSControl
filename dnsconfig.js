...
D("cxsrv.de", REGISTRAR, MAIL01,
  ...
  // DUS1 - DATA
  A("data", "161.97.146.6"), AAAA("data", "2a02:c206:3007:8578::1"),

  // DUS1 - Mail
  A("mail", "161.97.146.6"), AAAA("mail", "2a02:c206:3007:8578::1"),

  // DUS1 - MC
  A("mc", "161.97.146.6"), AAAA("mc", "2a02:c206:3007:8578::1"),

  // DUS1 - VOICE
  A("voice", "161.97.146.6"), AAAA("voice", "2a02:c206:3007:8578::1"),

  // NBG1-DC3 - VoiceOld
  A("voiceold", "162.55.60.38"), AAAA("voiceold", "2a01:4f8:1c1c:9680::1"),
...
D("rsmg-clan.de", REGISTRAR, MAIL01,
  ...
  // CNAME - DATA
  CNAME("cloud", "data.cxsrv.de."), CNAME("git", "voiceold.cxsrv.de."),
  CNAME("pma", "data.cxsrv.de."), CNAME("vpn", "data.cxsrv.de."),
  ...
  CNAME("crewlink", "voiceold.cxsrv.de."), CNAME("music", "voiceold.cxsrv.de."),
